jokes = ["I'm addicted to brake fluid, but I can stop whenever I want.",
...
alive = ["Close enough, I'd say", "In a matter of speaking, yes I am.", "I'll leave that for you to decide",
         ...
         "Try to realize the truth: there is no spoon", "As long as I can remember, I've had amnesia"
         ]

sorry = ["It's okay, don't worry about it", "No problem at all", "It's okay", "It's all good", "No harm done",
         "No worries", "It's okay, I forgive you"
         ]
